...
/*   Updated: 2025/07/01 15:24:34 by zoum             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	ft_rotate_ab(t_swap *swap, t_swap_int *elem)
{
...
void	ft_rotate_rr(t_swap *swap)
{
	if (!swap)
		return ;
	ft_rotate_ab(swap, swap->stack_a->first);
	ft_rotate_ab(swap, swap->stack_b->first);
