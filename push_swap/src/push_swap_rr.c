...
/*   Updated: 2025/07/01 01:55:38 by zoum             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	ft_reverse_rotate_ab(t_swap *swap, t_swap_int *elem)
{
...
void	ft_reverse_rotate(t_swap *swap, t_swap_int *elem)
{
	...
	{
		ft_reverse_rotate_ab(swap, elem);
...
void	ft_reverse_rotate_rr(t_swap *swap)
{
	if (!swap)
		return ;
	ft_reverse_rotate_ab(swap, swap->stack_a->first);
	ft_reverse_rotate_ab(swap, swap->stack_b->first);
